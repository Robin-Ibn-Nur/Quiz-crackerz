        ...
        <ul className="items-stretch hidden space-x-3 md:flex">
          ...
          <li className="flex">
            <Link to='/error'
              ...
              title='ErrorPage' className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">D-Fault-Error Page</Link>
          </li>
          <li className="flex">
            <Link to='/blog'
              aria-label='Blog'
        ...
        <div className='lg:hidden'>
          ...
          {isMenuOpen && (
            <div className='absolute top-0 left-0 w-full'>
              <div className='p-5 dark:bg-gray-800 dark:text-gray-100 text-white border rounded shadow-sm'>
